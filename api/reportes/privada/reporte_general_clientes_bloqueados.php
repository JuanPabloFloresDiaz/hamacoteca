...
$pdf = new Report;
$pdf->startReport('Clientes bloqueados');
$clientes = new ClientesData;

if ($dataclientes = $clientes->readAllBlocks()) {
    ...
    foreach ($dataclientes as $rowclientes) {
        ...
        $pdf->cell(25, 15, $pdf->encodeString($rowclientes['DUI']), 1, 1, 'C');
    }
} else {
    $pdf->cell(0, 15, $pdf->encodeString('No hay clientes bloqueados para mostrar'), 1, 1);
}

$pdf->output('I', 'clientes_bloqueados.pdf');
