...
if ($dataHamacas = $hamacas->readAll()) {
    ...
    $pdf->cell(37, 15, 'Nombre', 1, 0, 'C', 1);
    $pdf->cell(37, 15, 'Cantidad', 1, 0, 'C', 1);
    ...
    foreach ($dataHamacas as $rowHamacas) {
        ...
        $pdf->cell(37, 15, $pdf->encodeString($rowHamacas['NOMBRE']), 1, 0);
        $pdf->cell(37, 15, $pdf->encodeString($rowHamacas['CANTIDAD']), 1, 0);
        $pdf->cell(37, 15, $pdf->encodeString($rowHamacas['PRECIO']), 1, 0);
        $pdf->cell(37, 15, $pdf->encodeString($rowHamacas['ESTADO']), 1, 1);
        $y += 15;
    }
} else {
